...
function Button({children, className, disabled, onClick}: Children) {
  return (
    ...
    className={`${className} border border-gray-400/50 shrink-0 disabled:opacity-40
    cursor-pointer shadow rounded-lg active:scale-99 disabled:cursor-not-allowed 
