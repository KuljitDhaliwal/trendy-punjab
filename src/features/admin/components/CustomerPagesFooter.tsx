...
function CustomerPagesFooter({btn1Text, btn2Text, btn2ClickFun, btn1ClickFun, btn2disabled, btn1Color}: CustomerPageFooterType) {
    return (
        <div className="flex gap-4 justify-end sticky bottom-0 bg-white py-4">
            <Button children={btn1Text} onClick={btn1ClickFun} className={`px-4 py-2 text-[12px] ${btn1Color}`} />
